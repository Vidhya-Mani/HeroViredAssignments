...
const attempt = document.querySelector("h2");
const score_disp = document.querySelector("h4");
...
function check(){
    ...
    if(selected){
        ...
        attempt.innerHTML=`<center> You have attempted ${questNo+1} questions</center>`
        score_disp.innerHTML=`<h4> Your current score is: ${score} </h4>`
        ...
        if(questNo < quizArr.length){
            ...
            quizel.innerHTML = `
            <h3><center> You answered ${score}/${quizArr.length} questions correctly</center></h3>
